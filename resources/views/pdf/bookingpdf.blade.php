          ...
          <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
            <tr>
              <td class="email-masthead">
                <a href="https://kefcuts.com" class="f-fallback email-masthead_name">
                    <img src="https://kefcuts.com/images/kef_logo.png" width="100" height="50" alt="Kefcuts Logo">
                </a>
              </td>
            </tr>
            <!-- Email Body -->
                  ...
                  <tr>
                    <td class="content-cell" align="center">
                      <p class="f-fallback sub align-center">
                        Kefcuts, LLC
                        <br>Legend mall 
                        <br>2,edet bassey way, Thomas estate ajah
                        <br>Shop 29
                      </p>
                    </td>
                  </tr>
